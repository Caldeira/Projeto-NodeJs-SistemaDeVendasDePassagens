...
const router = Router();
import { PoltronaController } from "../controllers/PoltronaController";

const getController = (): PoltronaController => {
  return Container.get<PoltronaController>("PoltronaController");
};
